...
## Milestone 1: Setting up Conda Environment and Web Driver
...
- Next, a conda environement was set up with the necessary dependencies including `selenium`, `pip` and `ipykernel`. 
